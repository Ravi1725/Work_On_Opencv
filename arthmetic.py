...
# images are NumPy arrays, stored as unsiggrand_canyon.pngned 8 bit integers -- this
...
print("max of 255: " + str(cv2.add(np.uint8([250]), np.uint8([250]))))
...
print("wrap around: " + str(np.uint8([250]) + np.uint8([250])))
